package com.zalesskyi.photosapp.tools.view_binding
...
fun <F : Fragment, T : ViewBinding> Fragment.viewBindingFragment(viewBinder: (F) -> T): ViewBindingProperty<F, T> {
...
inline fun <F : Fragment, T : ViewBinding> Fragment.viewBinding(
    ...
    return viewBindingFragment { fragment: F -> vbFactory(viewProvider(fragment)) }
}
